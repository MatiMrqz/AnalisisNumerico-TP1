...
f= figure (1);
plot(t,G1, 'o-b', 'MarkerSize',5);
hold on;
plot(t,yt, 'x-r','MarkerSize', 5);
hold off;
xlabel('t');
ylabel('Integral');
title(sprintf('I = ∫e^-pt*sin(wt) dt, N = %d, w=%f',N,w));
legend('∫e^-pt*sin(wt) dt','e^-pt*sin(wt)', 'Location', 'Northeast');
grid on;
